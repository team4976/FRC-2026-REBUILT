...
public class GlobalCommands {
    ...
    public TurretReset c_turretReset;
    ...
    public void init(RobotContainer robotContainer){ System.out.println("print works GlobalCommand");
        ...
        c_flywheel = new FlywheelCommand(robotContainer.s_flywheel, robotContainer.s_updateHubInfo, robotContainer.s_turret);
        ...
        c_turretReset = new TurretReset(robotContainer.s_turret);
