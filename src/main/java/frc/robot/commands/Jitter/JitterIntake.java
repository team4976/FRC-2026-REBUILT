            ...
            Commands.repeatingSequence(
                Commands.deadline(Commands.waitSeconds(2), 
                    Commands.repeatingSequence(
                        ...
                        Commands.deadline(Commands.waitSeconds(0.20), s_intake.intakeCommand(true, -0.15,false)),
                        Commands.deadline(Commands.waitSeconds(0.20), s_intake.intakeCommand(true, -0.15,true))
                        )
                    ),
